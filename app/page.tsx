  ...
  Prequalify Now
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-16 border-b border-slate-100 pb-12">
            <div className="relative w-24 h-24 p-1 rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-600">
            ...
            <div className="text-center md:text-left">
              <h2 className="text-2xl font-bold text-slate-800">Tamarron Services</h2>
              <p className="text-slate-400 text-sm">@tamarronservices</p>
            </div>

            <div className="flex gap-8 text-center">
              <div>
                <p className="font-bold text-slate-800 text-lg">564</p>
                <p className="text-slate-400 text-xs uppercase tracking-wider">publicaciones</p>
              </div>
              <div>
                <p className="font-bold text-slate-800 text-lg">1.3 mil</p>
                <p className="text-slate-400 text-xs uppercase tracking-wider">seguidores</p>
              </div>
            </div>
            ...
            <Link 
              ...
              target="_blank"
              className="bg-[#4795eb] text-white px-6 py-2 rounded-lg font-bold text-sm flex items-center gap-2 hover:bg-blue-600 transition-colors"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {/* Post 1 */}
            <div className="relative aspect-square group overflow-hidden rounded-xl shadow-md">
              <Image src="/ig-post-1.jpg" alt="Instagram Post" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors"></div>
              <div className="absolute bottom-4 left-4 flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-white p-0.5"><Image src="/logo-circle.png" alt="Logo" width={32} height={32} className="rounded-full" /></div>
                <div className="text-white">
                  <p className="text-[10px] font-bold leading-none">Tamarron Services</p>
                  <p className="text-[8px] opacity-80">29 Abril 2026</p>
                </div>
              </div>
              <div className="absolute top-4 right-4 text-white opacity-80"><svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10h-4v4h-2v-4H7v-2h4V7h2v4h4v2z"/></svg></div>
            </div>

            {/* Post 2 */}
            <div className="relative aspect-square group overflow-hidden rounded-xl shadow-md">
              <Image src="/ig-post-2.jpg" alt="Instagram Post" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors"></div>
              <div className="absolute bottom-4 left-4 flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-white p-0.5"><Image src="/logo-circle.png" alt="Logo" width={32} height={32} className="rounded-full" /></div>
                <div className="text-white">
                  <p className="text-[10px] font-bold leading-none">Tamarron Services</p>
                  <p className="text-[8px] opacity-80">27 Abril 2026</p>
                </div>
              </div>
            </div>

            {/* Post 3 (Video/Reel Icon) */}
            <div className="relative aspect-square group overflow-hidden rounded-xl shadow-md">
              <Image src="/ig-post-3.jpg" alt="Instagram Post" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors"></div>
              <div className="absolute bottom-4 left-4 flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-white p-0.5"><Image src="/logo-circle.png" alt="Logo" width={32} height={32} className="rounded-full" /></div>
                <div className="text-white">
                  <p className="text-[10px] font-bold leading-none">Tamarron Services</p>
                  <p className="text-[8px] opacity-80">24 Abril 2026</p>
                </div>
              </div>
              <div className="absolute top-4 right-4 text-white opacity-80"><svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z"/></svg></div>
            </div>

            {/* Post 4 */}
            <div className="relative aspect-square group overflow-hidden rounded-xl shadow-md">
              <Image src="/ig-post-4.jpg" alt="Instagram Post" fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors"></div>
              <div className="absolute bottom-4 left-4 flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-white p-0.5"><Image src="/logo-circle.png" alt="Logo" width={32} height={32} className="rounded-full" /></div>
                <div className="text-white">
                  <p className="text-[10px] font-bold leading-none">Tamarron Services</p>
                  <p className="text-[8px] opacity-80">22 Abril 2026</p>
                </div>
              </div>
            </div>
