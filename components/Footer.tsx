"use client"; // Obligatorio para poder usar usePathname

import React from 'react';
import Image from 'next/image';
import { usePathname } from 'next/navigation'; // Hook para leer la ruta actual

const Footer = () => {
  const pathname = usePathname();

  // Verificamos si la URL actual empieza con la ruta del administrador
  const isAdminPath = pathname?.startsWith('/admin');

  return (
    <footer className="bg-[#2d2d2d] text-white py-8 md:py-12 data-[admin=false]:py-16 data-[admin=false]:md:py-20" data-admin={isAdminPath}>
      <div className="max-w-7xl mx-auto px-6">
        
        {/* ========================================================
            CONTENIDO COMPLETO (Se oculta si estamos en el Admin)
            ======================================================== */}
        {!isAdminPath && (
            ...
            <div className="flex flex-col items-center md:items-end gap-6">
              ...
              <div className="flex gap-4">
                ...
                <a 
                  ...
                  className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-slate-800 hover:text-[#00a4dd] transition-colors shadow-sm"
                >
                  <svg xmlns="http://www.w3.org/2000/xl" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5"></path></svg>
                </a>
              </div>
            </div>
          </div>
        ...
        {/* ========================================================
            BARRA DE COPYRIGHT (Se mantiene visible SIEMPRE)
            ======================================================== */}
        <div className={`pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-sm text-white font-light ${!isAdminPath ? 'border-t border-white/5' : ''}`}>
          <p>
