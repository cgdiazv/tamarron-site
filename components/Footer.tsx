...
<div className="flex flex-col gap-6">
  ...
  <div className="mt-2">
    <Image 
      src="/bbb-acredited.webp" // Updated from .png to .webp
  ...
  <form className="flex w-full max-w-sm bg-white rounded-full overflow-hidden p-1 shadow-sm">
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path>
          ...
          <div className="flex flex-col items-center md:items-end gap-6">
            ...
            <div className="flex gap-4">
              {/* Instagram */}
              <Link href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-slate-800 hover:text-[#00a4dd] transition-colors shadow-sm">
        ...
        {/* Bottom Bar: Changed font-medium to font-normal for a lighter look */}
<div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-sm text-white font-light">
  <p>
